  ...
  return (
    <div className="min-h-dvh flex items-center justify-center p-6 bg-neutral-50">
      <form onSubmit={onSubmit} className="w-full max-w-sm space-y-4 bg-white p-6 rounded-2xl shadow">
        <h1 className="text-xl font-semibold">Login – EHS Suite</h1>
        ...
        <p className="text-xs text-neutral-500">Need an account? <Link href="#" className="underline">Ask admin</Link></p>
      </form>
    </div>
  );
}
