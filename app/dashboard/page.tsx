export default async function Dashboard() {
  // data KPI masih dummy, nanti akan diambil dari Firestore
  const kpi = { 
    incidents: 3, 
    ppe: 96, 
    audit: 85, 
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="text-sm text-neutral-500">
        (Data masih dummy — nanti disambungkan ke Firestore koleksi <code>kpi_snapshots</code> untuk live data.)
      </div>
    </div>
  );
}